...
int main() {
    ...
    string decrypted_message = decryptMessage(message, method_choice, key1, key2);
    // assert(decryptChar('a', 2, "hello", "world") == 'h');
    // assert(decryptChar('a', 3, "hello", "world") == 'd');
    // assert(decryptChar('y', 3, "rock", "road") == 'a');
